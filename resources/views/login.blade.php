...
<div class="mt-20 bg-gradient-to-b from-pink-600 to-white rounded-xl border">
  <div class="p-4 sm:p-7">
    ...
    <!-- <div class="mt-5">
      ...
      <div class="py-1 flex items-center text-xs text-gray-400 uppercase before:flex-1 border-t border-gray-200 me-1 dark:border-neutral-600"></div>
      ...
      <form action="{{route('logar')}}" method="POST">
        ...
        <div class="grid gap-y-4">
          ...
          <div class="flex items-center">
            ...
            <div class="ms-3">
              <label for="remember-me" class="text-sm dark:text-white">Lembre de mim</label>
            </div>
          </div>
          <!-- End Checkbox -->
